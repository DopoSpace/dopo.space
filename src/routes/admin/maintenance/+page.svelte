...
<div class="space-y-6 max-w-4xl">
	...
	<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
		...
		<p class="text-sm text-gray-600 mb-4">
			Questo job viene eseguito automaticamente ogni giorno alle 5:00 (Europe/Rome). Usa questo
			pulsante per eseguire manualmente il controllo delle tessere scadute.
		</p>

		<p class="text-sm text-gray-600 mb-6">Per ogni tessera scaduta, il sistema:</p>
		...
		<button type="button" onclick={() => (showConfirmDialog = true)} class="btn-primary">
					...
					<div class="sm:flex sm:items-start">
						...
						<div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
							<h3 class="text-base font-semibold leading-6 text-gray-900">
								Conferma Controllo Scadenze
							</h3>
							<div class="mt-2">
								<p class="text-sm text-gray-500">
									Sei sicuro di voler eseguire il controllo delle scadenze? Questo job elaborerà
									tutte le tessere con data di scadenza passata e le imposterà come scadute.
								</p>
							</div>
						</div>
					</div>
