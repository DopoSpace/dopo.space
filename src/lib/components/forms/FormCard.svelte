<script lang="ts">
	...
	let { title, icon, subtitle, children }: Props = $props();
</script>
...
<style>
	...
	.form-card {
		@apply bg-white rounded-xl shadow-sm border border-gray-100 mb-6;
	...
	.form-card-header {
		@apply flex items-center gap-4 px-6 py-5 border-b border-gray-100 bg-gray-50/50;
	}
	...
	.form-card-subtitle {
		@apply text-sm text-gray-500 mt-0.5 m-0;
	}
